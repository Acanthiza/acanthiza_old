...
```{r stop, fig.cap = "Total stopping time"}
  ...
  dat %>%
    ...
    ggplot() +
      ...
      riderFill +
      guides(fill = FALSE) +
      labs(y = "Time stopped or moving at less than 5 km/h")
