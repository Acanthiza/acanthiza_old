...
Each rider carries a live gps tracker that, in combination with [map progress website](http://maprogress.com/), provides easily accessible ride data for each racer. (The full data for 2018 is available [here]("https://racetotherock2018.maprogress.com/locations/download/?eventId=1052&format=csv")). Some quick summary stats:
