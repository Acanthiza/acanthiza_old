...
Here's the data used in the pca.
...
```{r pcaGravel, fig.cap = "PCA for just the grave/endurance bikes"}
  ...
  datForPCAGravel <- dat %>%
    dplyr::filter(grepl("Gravel|Endurance|CX",Use))
